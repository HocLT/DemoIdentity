...
namespace DemoIdentity.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public IActionResult OnPost(string provider, string returnUrl = null)
        {
            ...
            // redirectUrl là url sẽ chuyển đến sau khi CallbackPath (/dang-nhap-tu-google) thi hành xong.
            // redirectUrl cũng chính là identity/account/externallogin?handler=Callback ~ gọi hàm OnGetCallbackAsync()
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            {
                // trường hợp tài khoản bị tạm khóa
